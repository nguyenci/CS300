...
public class ExceptionalClimbing {
   ...
   * @throws IllegalArgumentException if array is full, or string has invalid format
   * @throws DataFormatException      if array is null between i = 0 and numSend, numSend is
   *                                  negative
   */
   ...
   * @throws IllegalArgumentException if array is full, string is invalid format
   * @throws DataFormatException      if array is null between i = 0 and numFail, numFail is
   *                                  negative
   */
  public static int failClimb(String[] fail, int numFail, String grade)
    ...
    // validate grade
    if (grade.length() != 2 || grade.charAt(0) != 'V' || !(Character.isDigit(grade.charAt(1))
        && 48 <= grade.charAt(1) && grade.charAt(1) <= 55)) {
      throw new IllegalArgumentException(grade + " is not a valid grade");
    }
  ...
  public static String getStats(String[] send, int numSend, String[] fail, int numFail,
    ...
    // does IllegalArgumentException go before RuntimeException?
