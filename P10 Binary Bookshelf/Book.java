...
//
// Title: P10 Binary Bookshelf, Book class
...
public class Book {
   ...
   * @return true if o's attributes equals this book
   */
  @Override
  public boolean equals(Object o) {
    if (o instanceof Book) {
      if (((Book) o).getTitle() == this.getTitle() && ((Book) o).getAuthor() == this.getAuthor()
          && ((Book) o).getPageCount() == this.getPageCount() && ((Book) o).ID == this.ID) {
        return true;
      }
    }
    return false;
